...
The business entities of the application are listed in the Looping [LDM](_docs/MLD_looping.loo) and the [Entity](src/Entity) folder of the back-end.  
![UML](_docs/UML.png).
...
- Entities (in the [Entity](symfony/src/Entity) folder) created from the [MLD](Docs/mld_eboutique.pdf) and inheriting from [AbstractEntity](symfony/src/Entity/AbstractEntity.php).
